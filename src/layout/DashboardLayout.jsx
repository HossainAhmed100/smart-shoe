  ...
  return (
    <div className="flex w-full">
      ...
      <div className="flex items-center gap-3 px-3">
        ...
        <p className="text-small font-bold uppercase opacity-100">Smart Shoe</p>
        </div>
      </div>
        ...
        <div data-slot="base" className="w-full relative flex flex-col gap-1 p-1 list-none">
          ...
          <li className="relative mb-2 w-full">
            ...
            <ul className="mt-2 space-y-1">
              <li>
                <CustomNavLink path="/dashboard/manageProduct" title="Manage Product"/>
                <CustomNavLink path="/dashboard/addNewProduct" title="Add New Product"/>
                <CustomNavLink path="/dashboard/myProfile" title="My Profile"/>
              </li>
            </ul>
          </li>
          </nav>
